...
import {
  ...
  simulationFrames,
  shiftSummaries,
  supervisorActions as seedActions,
} from './data/mockData.js'
import { advanceFrame, getCurrentFrame, resetSimulation } from './services/simulation.js'
import type { ControllerProfile, SupervisorAction } from './types.js'
...
app.post('/auth/supervisor', (req, res) => {
  const { supervisorId, password } = req.body as { supervisorId?: string; password?: string }
...
app.post('/actions', (req, res) => {
  const payload = req.body as { controllerId?: string; action?: SupervisorAction['action']; message?: string }
