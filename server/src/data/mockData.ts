...
export const controllers: ControllerProfile[] = [
  ...
  },
  {
    id: 'C_Ali_011',
    name: 'Ali',
    password: 'pearl-controller-011',
    experienceYears: 6,
    yearOfBirth: 1995,
    gender: 'Male',
    healthNotes: 'Planner role. Coordinates shift schedules and resource allocation.',
    active: true,
    sectorId: 'CENTRAL',
    sectorName: 'Central Sector',
    shiftGroup: 'Central Sector – Midday Watch',
  ...
  },
  {
    id: 'C_Baraa_012',
    name: 'Baraa',
    password: 'pearl-controller-012',
    experienceYears: 7,
    yearOfBirth: 1994,
    gender: 'Male',
    healthNotes: 'Planner role. Manages workload distribution and backup assignments.',
    active: true,
    sectorId: 'EAST',
    sectorName: 'East Sector',
    shiftGroup: 'East Sector – Morning Rotation',
  ...
  },
  {
    id: 'C_Omar_013',
    name: 'Omar',
    password: 'pearl-controller-013',
    experienceYears: 5,
    yearOfBirth: 1996,
    gender: 'Male',
    healthNotes: 'Planner role. Handles shift planning and controller assignments.',
    active: true,
    sectorId: 'WEST',
    sectorName: 'West Sector',
    shiftGroup: 'West Sector – Evening Rotation',
