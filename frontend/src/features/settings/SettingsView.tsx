    ...
    <div className="space-y-8">
      ...
      <section className="rounded-2xl border border-slate-800 bg-slate-950/70">
        <div className="border-b border-slate-800 px-6 py-4">
          <h3 className="text-lg font-semibold text-slate-200">Shared module access matrix</h3>
          <p className="text-sm text-slate-400">Role-based controls ensure privacy and operational clarity.</p>
        </div>
          ...
          <table className="min-w-full divide-y divide-slate-800 text-sm">
            ...
            <tbody className="divide-y divide-slate-800/80 text-slate-200">
              {settingsMatrix.map((item) => (
                <tr key={item.option} className="hover:bg-slate-900/40">
                  ...
                  <td className="px-6 py-4 text-xs text-slate-400">{item.access}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <section className="rounded-2xl border border-slate-800 bg-slate-950/70 p-6 text-sm text-slate-300">
        <h3 className="text-lg font-semibold text-slate-200">Calibration</h3>
        <p className="mt-2">
          {role === 'supervisor'
